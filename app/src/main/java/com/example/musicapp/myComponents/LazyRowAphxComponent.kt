 ...
 */
@Composable
fun ImagesAphxList(aphxList: List<AlbumsId>, modifier: Modifier = Modifier) {
 ...
 */
@Composable
fun ImagesAphx(albumsId: AlbumsId) {
...
fun LazyRowComponentAphx() {
    ...
    ImagesAphxList(aphxList = DatasourceAphxPics().loadAlbumsAphx())
