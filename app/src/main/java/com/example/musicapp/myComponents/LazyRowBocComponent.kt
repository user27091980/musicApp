 ...
 */
@Composable
fun ImagesBocList(bocList: List<AlbumsId>, modifier: Modifier = Modifier) {
 ...
 */
@Composable
fun ImagesBoc(albumsId: AlbumsId) {
...
fun LazyRowComponentBoc() {
    ...
    ImagesBocList(bocList = DatasourceBocPics().loadAlbumsBoc())
